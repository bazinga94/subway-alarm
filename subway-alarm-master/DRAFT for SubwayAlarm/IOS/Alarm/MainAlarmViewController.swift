...
<<<<<<< HEAD:subway-alarm-master/DRAFT for SubwayAlarm/IOS/Alarm/MainAlarmViewController.swift
...
//        
>>>>>>> origin/master:DRAFT for SubwayAlarm/DRAFT for SubwayAlarm/IOS/Alarm/MainAlarmViewController.swift
        //셀에 string 넣기
