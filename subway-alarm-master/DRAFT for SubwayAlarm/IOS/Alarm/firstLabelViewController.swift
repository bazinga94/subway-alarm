...
class firstLabelViewController: UIViewController, UITextFieldDelegate {
    
    @IBOutlet weak var labelTextField: UITextField!
    var firstLabel: String! = "Alarm"
    ...
    override func viewDidLoad() {
        ...
        labelTextField.text = firstLabel
    ...
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        firstLabel = textField.text!
        performSegue(withIdentifier: Id.firstLabelUnwindIdentifier, sender: self)
